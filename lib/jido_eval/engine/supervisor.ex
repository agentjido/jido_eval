defmodule Jido.Eval.Engine.Supervisor do
  ...
  """
  @spec start_worker_pool(DynamicSupervisor.supervisor(), DynamicSupervisor.child_spec()) :: 
  ...
  """
  @spec stop_worker_pool(DynamicSupervisor.supervisor(), pid(), term()) :: 
    :ok | {:error, term()}
  ...
  """
  @spec list_worker_pools(DynamicSupervisor.supervisor()) :: 
    {:ok, [DynamicSupervisor.child()]} | {:error, term()}
  ...
  """
  @spec count_worker_pools(DynamicSupervisor.supervisor()) :: 
  ...
  """
  @spec stop_all_worker_pools(DynamicSupervisor.supervisor(), term(), timeout()) :: 
    :ok | {:error, term()}
  ...
  ## Examples
      ...
      IO.inspect(stats)
  """
  @spec get_stats(DynamicSupervisor.supervisor()) :: {:ok, map()} | {:error, term()}
