defmodule Jido.Eval.ResultTest do
  ...
  describe "finalize/2" do
    test "calculates summary statistics" do
      ...
      samples = [
        %{sample_id: "s1", scores: %{faithfulness: 0.8}, latency_ms: 1000, error: nil, tags: %{}, metadata: %{}},
        %{sample_id: "s2", scores: %{faithfulness: 0.9}, latency_ms: 1200, error: nil, tags: %{}, metadata: %{}},
        %{sample_id: "s3", scores: %{faithfulness: 0.7}, latency_ms: 800, error: nil, tags: %{}, metadata: %{}}
      ]
    ...
    test "calculates latency statistics" do
      ...
      samples = [
        %{sample_id: "s1", scores: %{faithfulness: 0.8}, latency_ms: 1000, error: nil, tags: %{}, metadata: %{}},
        %{sample_id: "s2", scores: %{faithfulness: 0.9}, latency_ms: 2000, error: nil, tags: %{}, metadata: %{}},
        %{sample_id: "s3", scores: %{faithfulness: 0.7}, latency_ms: 1500, error: nil, tags: %{}, metadata: %{}}
      ]
    ...
    test "calculates pass rate" do
      ...
      samples = [
        %{sample_id: "s1", scores: %{faithfulness: 0.8}, latency_ms: 1000, error: nil, tags: %{}, metadata: %{}},
        %{sample_id: "s2", scores: %{faithfulness: 0.3}, latency_ms: 1000, error: nil, tags: %{}, metadata: %{}},
        %{sample_id: "s3", scores: %{faithfulness: 0.7}, latency_ms: 1000, error: nil, tags: %{}, metadata: %{}}
      ]
    ...
    test "categorizes errors" do
      ...
      samples = [
        %{sample_id: "s1", scores: %{}, latency_ms: 1000, error: "timeout", tags: %{}, metadata: %{}},
        %{sample_id: "s2", scores: %{}, latency_ms: 1000, error: "llm_error: rate limit", tags: %{}, metadata: %{}},
        %{sample_id: "s3", scores: %{}, latency_ms: 1000, error: "timeout", tags: %{}, metadata: %{}}
      ]
    ...
    test "finalizes tag statistics" do
      ...
      samples = [
        %{sample_id: "s1", scores: %{faithfulness: 0.8}, latency_ms: 1000, error: nil, tags: %{"difficulty" => "easy"}, metadata: %{}},
        %{sample_id: "s2", scores: %{faithfulness: 0.9}, latency_ms: 1000, error: nil, tags: %{"difficulty" => "easy"}, metadata: %{}},
        %{sample_id: "s3", scores: %{}, latency_ms: 1000, error: "timeout", tags: %{"difficulty" => "hard"}, metadata: %{}}
      ]
      ...
      assert easy_stats.avg_score == 0.85
  ...
  describe "edge cases" do
    ...
    test "handles mixed successful and failed samples" do
      ...
      samples = [
        %{sample_id: "s1", scores: %{faithfulness: 0.8}, latency_ms: 1000, error: nil, tags: %{}, metadata: %{}},
        %{sample_id: "s2", scores: %{}, latency_ms: 1000, error: "failed", tags: %{}, metadata: %{}},
        %{sample_id: "s3", scores: %{faithfulness: 0.6}, latency_ms: 1000, error: nil, tags: %{}, metadata: %{}}
      ]
